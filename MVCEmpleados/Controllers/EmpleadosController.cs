...
namespace MVCEmpleados.Controllers
{
    public class EmpleadosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Nombre,FechaNacimiento,FechaContratacion,DepartamentoId,Salario,Descripcion")] Empleado empleado)
        {
            //Removemos la validacion de la propiedad de navegacion Departamento
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Nombre,FechaNacimiento,FechaContratacion,DepartamentoId,Salario,Descripcion")] Empleado empleado)
        {
            //Removemos la validacion de la propiedad de navegacion Departamento
            ModelState.Remove("Departamento");
